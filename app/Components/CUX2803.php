    ...
    if ($component['parent_device_interface'] == 'CUxD' && $component['visible'] == 'true' && isset($component['IP'])) {
        return '<div class="hh">'
            ...
            . '<div class="pull-right">'
                . '<span class="info" id="' . $component['INFO'] . '" data-component="' . $component['component'] . '" data-datapoint="INFO"></span>'
                //. '<span class="info" id="' . $component['IP'] . '" data-component="' . $component['component'] . '" data-datapoint="IP"></span>'
                //. '<span class="info" id="' . $component['UNREACH_CTR'] . '" data-component="' . $component['component'] . '" data-datapoint="UNREACH_CTR"></span>'
