        ...
        return '<div class="hh">'
            . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                ...
                . '<div class="pull-right">'
                    . '<span class="info" id="' . ($component['ACTUAL_TEMPERATURE']-22) . '" data-component="' . $component['component'] . '" data-datapoint="LOWBAT"></span>'
                    ...
                    . '<span class="info" id="' . $component['CONTROL_MODE'] . '" data-component="' . $component['component'] . '" data-datapoint="CONTROL_MODE"></span>'
                . '</div>'
