        ...
        return '<div class="hh">'
            . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                ...
                . '<div class="pull-right">'
                    . '<span class="info" id="' . ($component['LEVEL']-22) . '" data-component="' . $component['component'] . '" data-datapoint="LOWBAT"></span>'
                    . '<span class="info" id="' . $component['LEVEL'] . '" data-component="' . $component['component'] . '" data-datapoint="LEVEL"></span>'
                    . '<span class="info" id="' . ($component['LEVEL']+11) . '" data-component="' . $component['component'] . '" data-datapoint="COLOR"></span>'
                . '</div>'
