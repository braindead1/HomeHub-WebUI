        ...
        return '<div class="hh">'
            . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                ...
                . '<div class="pull-right">'
                    . '<span class="info" id="' . $component['ACTUAL_TEMPERATURE'] . '" data-component="' . $component['component'] . '" data-datapoint="ACTUAL_TEMPERATURE"></span>'
                    . '<span class="info" id="' . $component['SET_TEMPERATURE'] . '" data-component="' . $component['component'] . '" data-datapoint="SET_TEMPERATURE"></span>'
                    . '<span class="info" id="' . $component['ACTUAL_HUMIDITY'] . '" data-component="' . $component['component'] . '" data-datapoint="ACTUAL_HUMIDITY"></span>'
                    . '<span class="info" id="' . $component['BATTERY_STATE'] . '" data-component="' . $component['component'] . '" data-datapoint="BATTERY_STATE"></span>'
                    . '<span class="info" id="' . $component['WINDOW_OPEN_REPORTING'] . '" data-component="' . $component['component'] . '" data-datapoint="WINDOW_OPEN_REPORTING"></span>'
                    . '<span class="info set btn-icon" id="' . $component['CONTROL_MODE'] . '" data-component="' . $component['component'] . '" data-datapoint="CONTROL_MODE" data-set-id="" data-set-value""></span>'
                . '</div>'
