    ...
    if ($component['parent_device_interface'] == 'BidCos-RF' && $component['visible'] == 'true' && isset($component['TEMPERATURE'])) {
        return '<div class="hh">'
            ...
            . '<div class="pull-right">'
                . '<span class="info" id="' . ($component['TEMPERATURE']-24) . '" data-component="' . $component['component'] . '" data-datapoint="LOWBAT"></span>'
                ...
                . '<span class="info" id="' . $component['AIR_PRESSURE'] . '" data-component="' . $component['component'] . '" data-datapoint="AIR_PRESSURE"></span>'
            . '</div>'
