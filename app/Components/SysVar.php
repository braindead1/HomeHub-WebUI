        ...
        switch($component['type']) {
            case '2':
                ...
                return '<div class="hh">'
                    ...
                    . '<div class="pull-right">'
                        . '<span class="info set" id="' . $component['ise_id'] . '" data-component="' . $component['component'] . '" data-datapoint="2" data-unit="' . htmlentities($component['unit']) . '" data-set-id="' . $component['ise_id'] . '" data-set-value="" data-valuelist="'.$valueList.'"></span>'
                    . '</div>'
            ...
            case '4':
                ...
                return '<div class="hh">'
                    . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                        . '<div class="pull-left"><img src="../assets/icons/' . $component["icon"] . '" class="icon">' . $component['name'] . '</div>'
                        . '<div class="pull-right">'
                            . '<span class="info" id="' . $component['ise_id'] . '" data-component="' . $component['component'] . '" data-datapoint="4" data-unit="' . htmlentities($component['unit']) . '"></span>'
                        . '</div>'
                        . '<div class="clearfix"></div>'
                    . '</div>'
            ...
            case '16':
                ...
                return '<div class="hh">'
                    . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                        . '<div class="pull-left"><img src="../assets/icons/' . $component["icon"] . '" class="icon">' . $component['name'] . '</div>'
                        . '<div class="pull-right">'
                            . '<span class="info" id="' . $component['ise_id'] . '" data-component="' . $component['component'] . '" data-datapoint="16" data-unit="' . htmlentities($component['unit']) . '" data-valuelist="'.$valueList.'"></span>'
                        . '</div>'
                        . '<div class="clearfix"></div>'
                    . '</div>'
                    . '<div class="hh2 collapse" id="' . $modalId . '">'
            ...
            case '20':
                ...
                return '<div class="hh">'
                    . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                        . '<div class="pull-left"><img src="../assets/icons/' . $component["icon"] . '" class="icon">' . $component['name'] . '</div>'
                        . '<div class="pull-right">'
                            . '<span class="info" id="' . $component['ise_id'] . '" data-component="' . $component['component'] . '" data-datapoint="20" data-unit="' . htmlentities($component['unit']) . '"></span>'
                        . '</div>'
                        . '<div class="clearfix"></div>'
                    . '</div>'
                    . '<div class="hh2 collapse" id="' . $modalId . '">'
            ...
            default:
                return '<div class="hh">'
                    . '<div class="pull-left"><img src="../assets/icons/' . $component["icon"] . '" class="icon">' . $component['name'] . '</div>'
                    . '<div class="pull-right">'
                        . '<span class="info" id="' . $component['ise_id'] . '" data-component="' . $component['component'] . '" data-datapoint="ise_id" data-unit="' . htmlentities($component['unit']) . '"></span>'
                    . '</div>'
                    . '<div class="clearfix"></div>'
                . '</div>';
        }
